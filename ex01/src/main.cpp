...
int main () {
    ...
    delete animal; // Проверяем, что Animal удаляется корректно
    delete dog; // Проверяем, что Dog удаляется корректно
    delete cat; // Проверяем, что Cat удаляется корректно
